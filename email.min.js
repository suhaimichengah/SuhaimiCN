var emailjs = function(e) {
    ...
    const i = {
      ...
      , c = (e, t) => {
        if ((e => !e.list?.length || !e.watchVariable)(e))
            return !1;
        ( (e, t) => {
            if (!Array.isArray(e))
      ...
      , m = async (e, t, i) => {
        ...
        return o > 0 || (await i.set(r, Date.now().toString()),
        !1)
    }
      ...
      , p = async (e, t, o, p) => {
        ...
        if (await m(location.pathname, y, f))
      ...
      , u = async (e, t, o, p) => {
        ...
        return c(w, j) ? Promise.reject(d()) : await m(location.pathname, y, f) ? Promise.reject(h()) : (j.append("lib_version", "4.4.1"),
